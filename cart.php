...
<head>
        ...
        <title>Crave and Crust Bakery System|| cart Page</title>
...
?>
								...
								<td>RM<?php echo $total=$row['ItemPrice']?>
									<?php 
$grandtotal+=$total;
$cnt=$cnt+1; 
       			...
       			<div class="row cart_total_inner">
        			...
        			<div class="col-lg-5">
        				<div class="cart_total_text">
        					...
        					<div class="sub_total">
        						<h5>Sub Total <span>RM<?php echo $grandtotal;?>
                             </span></h5>
        					</div>
        					<div class="total">
        						<h4>Total <span>RM<?php echo $grandtotal;?></span></h4>
        					</div>
