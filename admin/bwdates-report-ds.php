...
<head>
    ...
    <title>Crave and Crust Bakery System|| Between Dates Report</title>
...
<form name="bwdatesreport"  action="bwdates-reports-details.php" method="post"> 
                ...
                <input type="radio" name="requesttype" value="">Not Confirmed Order
                  ...
                  <input type="radio" name="requesttype" value="Order Confirmed">Confirmed Order
                    <input type="radio" name="requesttype" value="Cake being Prepared">Cake Being Prepared Order
                      <input type="radio" name="requesttype" value="Cake Pickup">Cake Pickup Order
                      <input type="radio" name="requesttype" value="Cake Delivered">Cake Delivered order
                                        </div>
                                    </div>
