...
<head>
    <title>Crave and Crust Bakery System|| Manage Enquiry</title>
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                                 <table class="table table-bordered mg-b-0">
                                    <p style="text-align: center; color: blue;font-size: 30px">Manage Cake Unread Enquiry </p>
              <thead>
                <tr>
                  <<th>S.No</th>
                   <th>Name</th>
              ...
              <tr>
                     <td class="text-center"><?php echo($cnt);?></td>
                                        ...
                                        <td>
                                         ...
                                         <td><a href="view-enquiry.php?viewid=<?php echo $row['ID'];?>">View Details</a></td>
                  </tr>
                <?php 
$cnt=$cnt+1;
}?>
