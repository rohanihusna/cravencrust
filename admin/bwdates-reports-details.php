...
<head>
    ...
    <title>Crave and Crust Bakery System||Between Dates Report Details</title>
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php  echo $row['OrderTime'];?></td>
                                    <td><a href="viewcakeorder.php?orderid=<?php echo $row['Ordernumber'];?>">View Details</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
...
$cnt=$cnt+1;
                         ...
                         <?php if($rtype=="Cake being Prepared"){?>
                        <h4 align="center" style="color:blue">Report from <?php echo $fdate?> to <?php echo $tdate?> of Being Prepared Orders</h4>                          
                                 <table class="table table-bordered mg-b-0">
              <thead>
                <tr>
                  <th>S.NO</th>
              ...
              <?php
$ret=mysqli_query($con,"select * from tblorderaddresses where OrderFinalStatus='Cake being Prepared' && OrderTime between '$fdate' and '$tdate'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
...
$cnt=$cnt+1;
            ...
            <?php  if($rtype=="Cake Pickup"){?> 
            <h4 align="center" style="color:blue">Report from <?php echo $fdate?> to <?php echo $tdate?> of Order Pickup</h4>                         
                                 <table class="table table-bordered mg-b-0">
              <thead>
                <tr>
                  <th>S.NO</th>
              ...
              <?php
$ret=mysqli_query($con,"select * from tblorderaddresses where OrderFinalStatus='Cake Pickup' && OrderTime between '$fdate' and '$tdate'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
...
$cnt=$cnt+1;
            ...
            <h4 align="center" style="color:blue">Report from <?php echo $fdate?> to <?php echo $tdate?> of delivered Orders</h4>                         
              ...
              <?php
$ret=mysqli_query($con,"select * from tblorderaddresses where OrderFinalStatus='Cake Delivered' && OrderTime between '$fdate' and '$tdate'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
