...
<head>
        <title>Crave and Crust Bakery System || Cake Details</title>
        ...
        <section class="our_cakes_area p_100">
        	<div class="container">
        		<div class="main_title">
        			<h2>Our Cakes Categories</h2>
        			<h5>Offer a diverse selection of delicious flavors and stunning designs, thoughtfully crafted to cater to every taste, style, and celebration. Whether you’re looking for a classic chocolate indulgence, a fruity delight, or a custom-designed masterpiece, we have something to make every occasion extra special. Explore our wide range and let us bring your sweetest visions to life.</h5>
        		</div>
...
?>
					<div class="col-lg-3 col-md-4 col-6">
						<div class="cake_feature_item">
							<div class="cake_img">
								<img src="admin/itemimages/<?php echo $row['Image'];?>" width="300" height="302">
							</div>
							<div class="cake_text">
